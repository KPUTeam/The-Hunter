...
private:
	list<CDx11GameObject*>			m_MonsterList;
...
public:
	...
	list<CDx11GameObject*>* GetMonsterList();
...
public:
	...
	CDx11GameObject* FindMonsterFromTag(const string& strTag);
	CDx11GameObject* FindMonsterFromTypeName(const string& strTypeName);
