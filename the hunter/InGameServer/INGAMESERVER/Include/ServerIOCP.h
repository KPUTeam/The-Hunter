...
protected:
	...
	void MonsterPosition(class CUserSession* pSession, BYTE* pPacket);
	...
	void UserWin(class CUserSession* pSession, BYTE* pPacket);
	void UserLose(class CUserSession* pSession, BYTE* pPacket);
};
