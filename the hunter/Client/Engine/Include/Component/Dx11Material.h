...
public:
	void SetInfo(const Vec3& vDif, const Vec3& vAmb, const Vec3& vSpc,
		const Vec3& vEmv, float fPower, float fFadeAmount = 1.f);
	...
	void AddFadeAmount(float fAmount);
	void SubtractFadeAmount(float fAmount);
	void SetFadeAmount(float fAmount);
