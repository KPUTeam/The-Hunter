...
bool CDx11Window::Init(TCHAR * pTitle, TCHAR * pClass, HINSTANCE hInst, int iIconID, int iSmallIconID, RESOLUTION_TYPE eRT, WNDPROC pProc)
{
	m_hInst = hInst;
...
ATOM CDx11Window::MyRegisterClass(HINSTANCE hInst, TCHAR * pClass, int iIconID, int iSmallIconID, WNDPROC pProc)
{
	WNDCLASSEXW wcex;
...
BOOL CDx11Window::InitInstance(TCHAR * pTitle, TCHAR * pClass, RESOLUTION_TYPE eRT)
{
